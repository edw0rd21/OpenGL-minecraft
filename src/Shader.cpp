...
void Shader::load(const char* vertexPath, const char* fragmentPath)
{
    ...
    loadSource(vertexPath, fragmentPath, vertexCode, fragmentCode);
...
void Shader::loadSource(const char* vertexPath, const char* fragmentPath, std::string& vertexCode, std::string& fragmentCode) 
{
